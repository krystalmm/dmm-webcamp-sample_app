...
RSpec.describe 'Lists', type: :system do
  ...
  describe 'get top_path' do
    ...
    context 'responds successfully' do
      ...
      it 'succeeds current_path eq top' do
  ...
  describe '#new' do
    ...
    context 'responds successfully' do
      it 'succeeds current_path' do
        expect(current_path).to eq '/todolists/new'
      end

      it 'have_button post' do
  ...
  describe '#index' do
    ...
    context 'responds successfully' do
      it 'succeeds have link and content' do
  ...
  describe '#show' do
    ...
    context 'responds successfully' do
      it 'succeeds have delete link' do
        expect(page).to have_link 'Delete'
      end

      it 'succeeds have edit link' do
